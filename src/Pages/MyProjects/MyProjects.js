                    ...
                    <section className="mt-8 space-y-8 lg:mt-12">
                        <section className="lg:flex lg:items-center">
                            <div className="lg:w-1/2 ">
                                ...
                                <h2 className="mt-2 text-3xl font-semibold text-gray-800 capitalize lg:text-4xl dark:text-white">Block
                        ...
                        <section className="lg:flex lg:items-center">
                            <div className="lg:w-1/2 ">
                                ...
                                <h2 className="mt-2 text-3xl font-semibold text-gray-800 capitalize lg:text-4xl dark:text-white">Best
