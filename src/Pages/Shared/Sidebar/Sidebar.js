        ...
        <div>
            <div className="flex flex-col w-64 px-4 py-4 bg-transparent">
                ...
                <div className="flex flex-col justify-between flex-1 mt-6">
                    <nav>
                        <Link to={'/'} className="flex items-center px-4 py-1 my-1 text-gray-700 bg-gray-100 rounded-lg dark:bg-gray-800 dark:text-gray-200" href="#">
                        ...
                        <Link className="flex items-center px-4 py-1 my-1 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700" href="#">
                            <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <Link to={'/blog'} className="flex items-center px-4 py-1 my-1 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700" href="#">
                            <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
