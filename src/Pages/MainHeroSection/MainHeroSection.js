...
const MainHeroSection = () => {
    return (
        <div class="px-6 py-8">
            <div class="flex flex-col items-center py-6 lg:h-[36rem] lg:flex-row xl:min-h-screen">
                <div class="">
                    <h2 class="flex items-end text-lg md:text-xl lg:text-3xl font-semibold underline text-primary dark:text-slate-200">
                        Arif Uddin Raihan
                    ...
                    <h2 class="text-xl md:text-2xl font-normal text-black lg:text-5xl xl:text-6xl py-8 xl:py-16 dark:text-base-100">
                    ...
                    <h2 class="text-md md:text-lg font-light text-black lg:text-2xl font-mono dark:text-base-100">Leverage agile frameworks to provide a robust synopsis for high level overviews. Iterative approaches to corporate strategy foster collaborative thinking to further the overall value proposition. Organically grow the holistic world view of disruptive innovation via workplace diversity and empowerment.</h2>
                </div>
